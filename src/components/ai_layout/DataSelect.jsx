        ...
        if( Dimmed == true) {
                ...
                <div className={Styles.popup_wrap}>
                    ...
                    <div className={Styles.section_container}>
                        <div className={Styles.container_inner}>
                            ...
                            <div className={`${Styles.section_content} ${Styles.data_select_content}`}>
                    ...
                    {/* 딤드 영역 */}
                    <div className={Styles.dimmed} style={{ display: 'block ' }}>
            ...
            return (
                <div className={Styles.popup_wrap}>
                    ...
                    {/* 딤드 영역 */}
                    <div className={Styles.dimmed} style={{ display: 'none ' }}>
                        <div className={Styles.more_popup}>
                            <div className={Styles.contents}>
                                <strong className={Styles.more_sjt}>
                                    한국국제교류재단 한국음식정보
