...
class TableSummary extends Component {
    render () {
        // [D] ZoonIn : 마크업 확인용 / 스펙에 맞게 변경해주세요
        const { SummaryState, ZoonIn } = this.props;
            ...
            return (
                <Fragment>
                    <div className={Styles.popup_wrap}>
                        ...
                        <div className={`${Styles.section_container} ${Styles.summary_container} ${ZoonIn ? `${Styles.zoom_in}` : ''}`}>
                                ...
                                <div className={Styles.section_content}>
                                    <div className={Styles.sheet_form_box}>
                                        ...
                                        <div className={Styles.btn_box}>
                                            ...
                                            */}
                                            <a href="/" role="button" className={`${Styles.btn_zoom_in} ${ZoonIn ? `${Styles.active}` : ''}`}>
                                                <span className={Styles.blind}>{ZoonIn ? '작게 보기' : '크게 보기'} </span>
                                            </a>
                                            ...
                                            <div className={Styles.inner}>
                                                ...
                                                <div className={Styles.chart_wrap}>
                                                    <div className={Styles.category_box}>
                                                        ...
                                                        <div className={Styles.table_sjt}>
                                                            <strong>제공처</strong>
                                                            <p className={Styles.title_dsc}>Palmer Station Antarctica LTER</p>
                                                        </div>
                                                        <div className={Styles.table_sjt}>
                                                            <strong>상세</strong>
                                                            <p className={Styles.title_dsc}>남극의 파머 기지(Palmer Station) 근처에서 먹이를 찾는 333마리의 성체 펭귄에 대해 품종, 서식지, 부리 길이, 부리 깊이, 날개 길이, 몸무게, 성별을 정리한 데이터셋입니다. 이 데이터셋은 붓꽃 데이터의 대안으로 사용 됩니다.</p>
                                                        </div>
                                                    </div>
                                                    <div className={Styles.category_box}>
                                                        <div className={Styles.table_sjt}>
                                                        ...
                                                        <div className={Styles.table_sjt}>
                                                            ...
                                                            <ul className={Styles.dsc_list}>
                                                                <li>품종: 관측된 펭귄의 종류로 아델리(Adelie) 펭귄, 턱끈(Chinstrap) 펭귄, 젠투(Gentoo) 펭귄의 3종류입니다.</li>
                                                                <li>부리 깊이: 위 부리의 위쪽 표면부터 아래 부리의 아래쪽 표면까지의 길이를 말합니다. (mm)</li>
                                                                <li>몸무게: 펭귄의 몸무게(body mass)입니다. (g)</li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                                    <div className={Styles.category_box}>
                                                    ...
                                                    <ul className={Styles.chart_list}>
                                                        <li>
                                                            <a href="#" className={`${Styles.chart_link} ${Styles.bar}`}>
                                                                <strong className={Styles.title}>부리 깊이 막대 그래프</strong>
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <a href="#" className={`${Styles.chart_link} ${Styles.histogram}`}>
                                                                <strong className={Styles.title}>부리 길이 히스토그램</strong>
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <a href="#" className={`${Styles.chart_link} ${Styles.scatter}`}>
                                                                <strong className={Styles.title}>점 차트</strong>
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <a href="#" className={`${Styles.chart_link} ${Styles.scatter_matrix}`}>
                                                                <strong className={Styles.title}>산점도 행렬</strong>
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <a href="#" className={`${Styles.chart_link} ${Styles.pie}`}>
                                                                <strong className={Styles.title}>품종의 비율을 나타내는 파이차트</strong>
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <a href="#" className={`${Styles.chart_link} ${Styles.line}`}>
                                                                <strong className={Styles.title}>선 그래프</strong>
                                                            </a>
                                                        </li>
                                                    </ul>
                                                </div>
                                    ...
                                    <div className={Styles.chart_box}>
                                        ...
                                        <div className={Styles.inner}>
                                            <div className={Styles.chart_navi}>
                                                ...
                                                <a href="#" className={`${Styles.chart_link} ${Styles.scatter_matrix} ${Styles.disabled}`}>
                                                    <span className={Styles.blind}>산점도 행렬</span>
                                                </a>
                                                <div className={Styles.add_link_box}>
                                                    <a href="#" className={`${Styles.add_link} ${Styles.disabled}`} role="button">
                                                        <span className={Styles.blind}>추가하기</span>
                                                    </a>
                                                    {/* 추가하기 링크가 클릭되면 display: block 처리 해주세요 */}
                                                    <div className={Styles.tooltip_graph_box} style={{ display: 'none' }}>
