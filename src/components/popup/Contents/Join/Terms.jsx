...
class Terms extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            termAgree: false,
            individualInfoCollectAgree: false,
        };
    ...
    moveNext(event) {
        ...
        if (this.state.termAgree && this.state.individualInfoCollectAgree) {
            this.props.moveTo(1);
        } else {
    ...
    drawErrorMsg(type, message) {
        if (this.state.alertMessageShow && !this.state[type]) {
            return <p className={Styles.error_dsc}>{message}</p>;
        }
        return '';
    }
            ...
            <section className={`${Styles.pop_content} ${Styles.login_area}`}>
                <section className={Styles.login_header}>
                    ...
                    <div className={Styles.pop_btn_box}>
                        <a href="#NULL"
                           className={CommonUtils.toggleClass(this.props.joinReducer.job === 'student', Styles.active)}
                           onClick={(e) => this.handleClick(e, 'student')}>학생</a>
                        <a href="#NULL"
                           className={CommonUtils.toggleClass(this.props.joinReducer.job === 'teacher', Styles.active)}
                           onClick={(e) => this.handleClick(e, 'teacher')}>선생님</a>
                    </div>
                </section>
                    ...
                    <div className={Styles.agree_box}>
                                <span className={Styles.pop_checkbox}>
                                    <input
                                        ...
                                        onChange={() => this.handleCheck('termAgree')}
                                        defaultChecked={this.state.termAgree}
                                    />
                        ...
                        {/* 이용약관에 동의하지 않았을때 문구 */}
                        {this.drawErrorMsg('termAgree', '* 이용약관에 동의해주세요.')}
                    </div>
                    <div className={Styles.agree_box}>
                                <span className={Styles.pop_checkbox}>
                                    <input type="checkbox" id="agree_chk2" name="agree_chk2" className={Styles.blind}
                                           onChange={() => this.handleCheck('individualInfoCollectAgree')}
                                           defaultChecked={this.state.individualInfoCollectAgree}/>
                        ...
                        <div className={Styles.round_box}>
                            ...
                            <p>
                                ...
                                <br/>
                                개인정보침해신고센터 (
                                <a href="http://privacy.kisa.or.kr" target="_blank" rel="noopener noreferrer">
                                    http://privacy.kisa.or.kr
                                </a>{' '}
                                / 국번없이 118)
                                <br/>
                                대검찰청 사이버수사과 (
                                <a href="http://spo.go.kr" target="_blank" rel="noopener noreferrer">
                                    http://spo.go.kr
                                </a>{' '}
                                / 국번없이 1301)
                                <br/>
                                경찰청 사이버안전국 (
                                <a href="http://www.ctrc.go.kr" target="_blank" rel="noopener noreferrer">
                                    http://www.ctrc.go.kr
                                </a>{' '}
                                / 국번없이 182)
                            </p>
                        ...
                        {/* 이용약관에 동의하지 않았을때 문구 */}
                        {this.drawErrorMsg('individualInfoCollectAgree', '* 개인정보 수집 및 이용에 대한 안내에 동의해주세요.')}
                    </div>
                    <div className={Styles.pop_btn_box}>
                        <a href="#NULL" className={Styles.active} onClick={this.moveNext}>다음</a>
                    </div>
                </section>
            </section>
        );
...
const mapDispatchToProps = (dispatch) => ({
    ...
    setJob: (job) => dispatch(JoinAction({ job: job })),
});
