...
class Sample extends Component {
    ...
    render() {
                        ...
                        <div className={Styles.section_container}>
                            <div className={Styles.container_inner}>
                                <div className={Styles.section_navi}>
                                    ...
                                    {/* 검색 요소가 선택되면 active 클래스 추가 */}
                                    <div className={`${Styles.srch_box} ${Styles.active}`}>
                                        <label htmlFor="srch">
                                        ...
                                        <button
                                            type="button"
                                            className={`${Styles.btn_srch} ${Styles.imbtn_pop_srch} ${Styles.active}`}
                                        >
                                ...
                                <div class={Styles.section_content}>
                                    ...
                                    <div className={Styles.content_box}>
                                        <div className={Styles.sub_tab}>
                                            ...
                                            <div className={Styles.checkbox}>
                                                {/* 인풋 요소에 checked는 텍스트가 눌려질때 토글 해주세요 */}
                                                <input type="checkbox" id="vector" name="vetor" className={Styles.blind} />
                                        ...
                                        <div className={Styles.list_area}>
                                            ...
                                            <li className={Styles.on}>
                                                <div className={Styles.link}>
                                                    <div className={`${Styles.thmb} ${Styles.svg}`}>
                                                        <img
                                    ...
                                    <div className={Styles.obj_select_cont}>
                                        <strong className={Styles.sjt}>전체(999)</strong>
                                        <div className={Styles.select_list}>
                                            <ul className={Styles.list}>
                                                {/* 오브젝트가 없읋때 empty 클래스 추가 */}
                                                ...
                                                <li>
                                                    ...
                                                    <a href="/" className={Styles.btn_del} role="button">
        ...
        } else if (SampleState == 'FileUpload') {
            return (
                <div>
                    {/* 파일 올리기 팝업 */}
                    <div className={Styles.popup_wrap}>
                        ...
                        <div className={Styles.section_container}>
                            <div className={Styles.container_inner}>
                                ...
                                <div className={`${Styles.section_content} ${Styles.file_add_list_content}`}>
                                    ...
                                    <div className={Styles.caution_box}>
                                        ...
                                        <p className={Styles.caution}>
                                            ...
                                            <span className={Styles.sub_dsc}>폭력적이고 잔인한 그림, 선정적인 신체 노출 그림, 불쾌감을 주거나 혐오감을 일으키는 그림, 무단 사용이 금지된 저작권의 그림</span> <a href="/">[저작권에 대해 알아보기]</a>
                                        </p>
                                    </div>
                                </div>
                            </div>
        ...
        } else if (SampleState == 'FileLoading') {
            return (
                <div>
                    {/* 파일 올리기 팝업 */}
                    <div className={Styles.popup_wrap}>
                        <header className={Styles.pop_header}>
                            ...
                            <a href="/" className={`${Styles.btn} ${Styles.disabled}`} role="button">추가하기</a>
                        </header>
                        <div className={Styles.section_container}>
                            <div className={Styles.container_inner}>
                                <div className={Styles.section_navi}>
                    ...
                    <div className={Styles.popup_wrap}>
                        ...
                        <div className={Styles.section_container}>
                            <div className={Styles.container_inner}>
                                ...
                                <div className={`${Styles.section_content} ${Styles.drawing_content}`}>
                                    <p className={Styles.drawing_dsc}>
                                        그림을 직접 그려서 추가할 수 있습니다.<br />그리기 화면으로 이동할까요?
                                    </p>
        ...
        } else if (SampleState == 'ShortWrite') { 
            return (
                <div>
                    {/* 짧은 글상자 팝업 */}
                    <div className={Styles.popup_wrap}>
                        ...
                        <div className={Styles.section_container}>
                            <div className={Styles.container_inner}>
                                ...
                                <div className={`${Styles.section_content} ${Styles.writing_content}`}>
        ...
        } else if (SampleState == 'MultiWrite') { 
            return (
                <div>
                    {/* 긴 글상자 팝업 */}
                    <div className={Styles.popup_wrap}>
                                    ...
                                    <div className={Styles.write_box}>
                                        <div className={Styles.write_set}>
                                            ...
                                            <div className={Styles.font_style_box}>
                                                ...
                                                {/* 노멀 */}
                                                <div
                                                    className={`${Styles.style_link} ${Styles.imbtn_pop_font_paint}`}
                                                    title="배경색"
                                                >
                                                ...
                                                <div
                                                    className={`${Styles.style_link} ${Styles.imbtn_pop_font_paint} ${Styles.clear}`}
                                                    title="배경색"
                                                >
                                                    {/* 팔레트에 선택되는 색상으로 넣어주세요. */}
                                                ...
                                                <div
                                                    className={`${Styles.style_link} ${Styles.imbtn_pop_font_paint} ${Styles.clear_on}`}
                                                    title="배경색"
                                                >
                                                    {/* 팔레트에 선택되는 색상으로 넣어주세요. */}
                                                    <em style={{ backgroundColor: '#fff'}}></em> 
                                                ...
                                                <div
                                                    className={`${Styles.style_link} ${Styles.imbtn_pop_font_paint} ${Styles.on}`}
                                                    title="배경색"
                                                >
                                                    {/* 팔레트에 선택되는 색상으로 넣어주세요. */}
                                                    <em style={{ backgroundColor: '#f00'}}></em> 
        ...
        } else if (SampleState == 'ExpandBlock') { 
            return (
                <div>
                    <div className={Styles.popup_wrap}>
                        <header className={Styles.pop_header}>
                        ...
                        <div className={Styles.section_container}>
                            <div className={Styles.container_inner}>
                                <div className={`${Styles.section_content} ${Styles.extend_content}`}>
                                        ...
                                        <ul className={Styles.list}>
                                            ...
                                            <li>
                                                <div className={Styles.link}>
                                                    ...
                                                    <div className={Styles.inner_box}>
                                                        <strong className={Styles.sjt}>번역</strong>
                                                        <p className={Styles.dsc}>
                                                            파파고를 이용하여 다른 언어로 번역할 수 있는 블록 모음입니다. [네이버 제공]
                                                        </p>
                                                    </div>
                                                </div>
                                            </li>
                                            <li>
                                                <div className={Styles.link}>
                                                    ...
                                                    <div className={Styles.inner_box}>
                                                        <strong className={Styles.sjt}>생활안전</strong>
                                                        <p className={Styles.dsc}>
                                            ...
                                            <li>
                                                <div className={Styles.link}>
                                                    ...
                                                    <div className={Styles.inner_box}>
                                                        <strong className={Styles.sjt}>센서</strong>
                                                        <p className={Styles.dsc}>
                                            ...
                                            <li>
                                                <div className={Styles.link}>
                                                    ...
                                                    <div className={Styles.inner_box}>
                                                        <strong className={Styles.sjt}>인공지능</strong>
                                                        <p className={Styles.dsc}>
                                            ...
                                            <li>
                                                <div className={Styles.link}>
                                                    <div className={Styles.thmb}>&nbsp;</div>
                                                    <div className={Styles.inner_box}>
                                                        <strong className={Styles.sjt}>읽어주기</strong>
                                                        <p className={Styles.dsc}>
                                                            nVoice 음성합성 기술로 다양한 목소리로 문장을 읽는 블록 모음입니다. [네이버 제공]
                                                        </p>
                                                    </div>
                                                </div>
                                            </li>
                                            <li>
                                                <div className={Styles.link}>
                                                    ...
                                                    <div className={Styles.inner_box}>
                                                        <strong className={Styles.sjt}>자연재난 국민행동요령</strong>
                                                        <p className={Styles.dsc}>
                                            ...
                                            <li>
                                                <div className={Styles.link}>
                                                    <div className={Styles.thmb}>&nbsp;</div>
                                                    <div className={Styles.inner_box}>
                                                        <strong className={Styles.sjt}>행사</strong>
                                                        <p className={Styles.dsc}>
        ...
        } else if (SampleState == 'SoundSelect') { 
            return (
                <div>
                    {/* 소리 선택 팝업 */}
                    <div className={Styles.popup_wrap}>
                                ...
                                <div className={`${Styles.section_content}`}>
                                    ...
                                    <div className={Styles.content_box}>
                                        <div className={Styles.sub_tab}>
                                            <div className={Styles.menu_inner}>
                                            {/* [D] 링크가 클릭되면 li 요소에 on 클래스 추가 */}
                                                <div className={Styles.on}>전체</div>
                                                <div>일상</div>
                                                <div>스포츠</div>
                                            </div>
                                        </div>
                                        <div className={`${Styles.list_area} ${Styles.sound_list_area}`}>
                                            <ul className={Styles.obj_list}>
                                            {/* [D] 오브젝트 링크가 클릭되면 li에 on  추가 */}
                                                <li className={Styles.on}>
                                                    <div className={Styles.link}>
                                                        <div className={Styles.thmb}>
                                                            {/* 소리바 일 경우 type_sound 클래스 추가  */}
                                                            {/* 재생 아이콘 경우 type_play 클래스  추가 */}
                                                            <div className={Styles.type_sound}>
                                                ...
                                                <li className={Styles.on}>
                                                    <div className={Styles.link}>
                                                        <div className={Styles.thmb}>
                                                            {/* 소리바 일 경우 type_sound 클래스 추가  */}
                                                                {/* 재생 아이콘 경우 type_play 클래스  추가 */}
                                                            <div className={Styles.type_play}>
                                                                <span className={Styles.play} />
                                                            </div>
                                                        </div>
                                                        <em className={Styles.sjt}>소리명소리명소리명소리명소리명소리명소리명</em>
                                                    </div>
                                                </li>
                                            </ul>
                                        </div>
        ...
        } else if (SampleState == 'SoundUpload') {
            return (
                <div>
                    {/* 소리 올리기 팝업 */}
                    <div className={Styles.popup_wrap}>
                            ...
                            <div className={Styles.container_inner}>
                                ...
                                <div className={`${Styles.section_content} ${Styles.file_add_list_content}`}>
                                        ...
                                        {/* [D] 오브젝트 링크가 클릭되면 li에 on  추가 */}
                                            <li className={Styles.on}>
                                                <div className={Styles.link}>
                                                    ...
                                                    <em className={Styles.sjt}>소리명명명</em>
                                                </div>
                                            </li>
                                            <li className={Styles.on}>
                                                <div className={Styles.link}>
                                    ...
                                    <div className={Styles.caution_box}>
                                        ...
                                        <p className={Styles.caution}>
                                            <strong>아래와 같은 소리는 이용약관 및 관련 법률에 의해 제재를 받으실 수 있습니다.</strong><br />
                                            <span className={Styles.sub_dsc}>폭력적이고 잔인한 소리, 선정적인 내용의 소리, 불쾌감을 주거나 혐오감을 일으키는 소리, 무단 사용이 금지된 저작권의 소리</span> <a href="/">[저작권에 대해 알아보기]</a>
                                        </p>
                                    </div>
                                </div>
                            </div>
        ...
        } else if (SampleState == 'SignUp1') { 
            return (
                <div>
                    {/* 회원가입 팝업1 */}
                    <div className={`${Styles.popup_wrap} ${Styles.login_wrap}`}>
                        <header className={Styles.pop_header}>
                            <h1>회원가입</h1>
                            <button
                                onClick={this.close}
                        ...
                        <div className={Styles.section_container}>
                            <div className={Styles.container_inner}>
                                <div className={`${Styles.section_content} ${Styles.login_area}`}>
                    ...
                    <div className={Styles.popup_wrap}>
                        ...
                        <div className={Styles.section_container}>
                            <div className={Styles.container_inner}>
                                ...
                                <div className={`${Styles.section_content} ${Styles.art_content}`}>
                ...
                <div>
                    ...
                    <div className={Styles.popup_wrap}>
                        <header className={Styles.pop_header}>
                            ...
                            <a href="/" className={`${Styles.btn} ${Styles.disabled}`} role="button">불러오기</a>
                        </header>
                        <div className={Styles.section_container}>
                            <div className={Styles.container_inner}>
                                <div className={Styles.section_navi}>
